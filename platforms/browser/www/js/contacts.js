...
function address_list() {
  var member_srl = window.localStorage.getItem("member_srl");
   $.post("http://officemaster.iwinv.net/save_phonenumber_check.php",
               {
...
function save_phonenumber(name,telephone) {
  ...
  var name=name;
  var telephone=telephone;
  $.post("http://officemaster.iwinv.net/save_phonenumber.php",
               {
                member_srl:member_srl,
                name:name,
                telephone:telephone
...
function save_contact_update(data) {
  var member_srl = window.localStorage.getItem("member_srl");
  var data=data;
  $.post("http://officemaster.iwinv.net/save_contact_update.php",
               {
                member_srl:member_srl,
                data:data
                   },
...
function view_contact() {
  ...
  var data=data;
  $("#contacts_modal").addClass('active');
  $.post("http://officemaster.iwinv.net/contact_list.php",
               {
                member_srl:member_srl
                   },
               function(data){
