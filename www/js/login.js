...
function join_popup() {
    ...
    var url="http://officemaster.iwinv.net/xe/index.php?act=dispMemberSignUpForm";
...
function find_pw() {
    ...
    var url="http://officemaster.iwinv.net/xe/index.php?mid=index&act=dispMemberFindAccount&m=1";
...
function save_member() {
    ...
    if (!nick_name) {
        ...
        return;
                ...
                $.post("http://officemaster.iwinv.net/join_member.php",
               {
                email:join_email,
                password:join_pw1,
                nick_name:nick_name,
